...
const getAllBorrowRecords = asyncHandler(
...
const getBorrowRecordsByBook = asyncHandler(
...
const getBorrowRecordsByUser = asyncHandler(
...
const borrowBook = asyncHandler(
    async (req: BorrowBookRequest, res: Response): Promise<void> => {
...
const returnBook = asyncHandler(
    async (req: ReturnBookRequest, res: Response): Promise<void> => {
